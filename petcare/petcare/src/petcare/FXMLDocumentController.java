...
public class FXMLDocumentController {
    ...
    @FXML private TableView<Pets> tableView;
    @FXML private TableColumn<Pets, Integer> idCol;
    @FXML private TableColumn<Pets, String> nameCol, deptCol, emailCol;
    @FXML private TableColumn<Pets, Double> gpaCol;

    private final ObservableList<Pets> studentList = FXCollections.observableArrayList();
    private Connection connection;

    public void initialize() {
        // Bind table columns to Pets properties
    ...
    private void handleUpdate() {
        Pets selected = tableView.getSelectionModel().getSelectedItem();
        if (selected == null) {
